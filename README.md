...
* For Mobile: https://github.com/zubairehman/flutter-Flimmer-project/tree/master (stable channel)
* For Web: https://github.com/zubairehman/flutter-Flimmer-project/tree/feature/web-support (beta channel)
...
```
https://github.com/zubairehman/flutter-Flimmer-project.git
```
...
```dart
import 'package:Flimmer/routes.dart';
import 'package:flutter/material.dart';
